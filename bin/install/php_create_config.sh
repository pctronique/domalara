...
sed -i "s/#- .\/.docker\/laravel\/php.ini:\/usr\/local\/etc\/php\/conf.d\/php.ini:ro/- .\/.docker\/laravel\/php.ini:\/usr\/local\/etc\/php\/conf.d\/php.ini:ro/" "$REAL_PATH/../../docker-compose.yml" 
